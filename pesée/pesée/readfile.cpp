...
// Constants
//-----------------------------------------------------------------------------
static const char * FILE_PATH		= ".\\Plateaux456Courbe81.tdms";
...
void SaveDataintoFile(char *filename, double *data,char *property,unsigned int i,unsigned __int64 numDataValues);
//Global variables
...
int main (int argc, char *argv[])
{
	...
	//System::Windows::Forms::Application::Run(form);/*Another way to open a new form*/
...
static int ReadChannels (DDCChannelGroupHandle group)
{
	...
	for (i = 0; i < numChannels; ++i)
		...
		// Save local data to global variables
